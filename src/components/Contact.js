...
const Contact = () => {
    return (
        <section id="contact" className="relative bg-white">
          <div className="container max-w-7xl px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
              <div className="relative flex flex-wrap py-6 rounded shadow-md">
                ...
                <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                  ...
                  <a className="text-indigo-400 leading-relaxed" href="mailto:burhan.koeseler@hotmail.de">
                    burhan.koeseler@hotmail.de
                  </a>
                  <h2 className="title-font font-semibold  tracking-widest text-xs mt-4">
                    PHONE
                  </h2>
                  <p className="leading-relaxed">+81 80 7409 7126</p>
                </div>
              </div>
            </div>
            <form
